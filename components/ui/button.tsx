...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "bg-brand-500 text-surface hover:bg-brand-600 active:bg-brand-600",
        secondary: "bg-ink-100 text-ink-900 hover:bg-ink-200 active:bg-ink-200",
        destructive: "bg-danger text-surface hover:opacity-90 active:opacity-80",
        ghost: "text-ink-600 hover:bg-subtle hover:text-ink-900 active:bg-ink-100",
      },
      size: {
        sm: "h-7 px-3",
        md: "h-9 px-4",
